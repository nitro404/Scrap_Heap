...
namespace KiloWatt.Base.Graphics
{
  public class DrawDetails
  {
    ...
    {
      Dev = dev;
      VertexPD = new VertexDeclaration(dev, new VertexElement[] {
        new VertexElement(0, 0, VertexElementFormat.Vector3, VertexElementMethod.Default, VertexElementUsage.Position, 0),
      });
      VertexPCD = new VertexDeclaration(dev, VertexPositionColor.VertexElements);
      VertexPTD = new VertexDeclaration(dev, VertexPositionTexture.VertexElements);
      VertexPCTD = new VertexDeclaration(dev, VertexPositionColorTexture.VertexElements);
      VertexPNTD = new VertexDeclaration(dev, VertexPositionNormalTexture.VertexElements);
      VertexPNhThBhTD = new VertexDeclaration(dev, new VertexElement[] {
        new VertexElement(0, 0, VertexElementFormat.Vector3, VertexElementMethod.Default, VertexElementUsage.Position, 0),
        new VertexElement(0, 12, VertexElementFormat.HalfVector4, VertexElementMethod.Default, VertexElementUsage.Tangent, 0),
        new VertexElement(0, 20, VertexElementFormat.HalfVector4, VertexElementMethod.Default, VertexElementUsage.Normal, 0),
        new VertexElement(0, 28, VertexElementFormat.HalfVector4, VertexElementMethod.Default, VertexElementUsage.Binormal, 0),
