...
namespace XNAQ3Lib.MD5
{
    public class ModelMD5
    {
        ...
        public void Draw(Texture2D texture, Matrix view, Matrix projection)
        {
            ...
            graphicsDevice.VertexDeclaration = new VertexDeclaration(graphicsDevice, MD5VertexFormat.VertexElements);
        ...
        public void DrawBounds(Matrix view, Matrix projection)
        {
            ...
            graphicsDevice.Vertices[0].SetSource(boundingBoxVertexBuffer, 0, VertexPositionColor.SizeInBytes);
